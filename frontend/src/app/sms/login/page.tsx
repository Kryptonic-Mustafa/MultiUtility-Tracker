          ...
          <form onSubmit={handleRegister} className="space-y-4 animate-in fade-in duration-200">
            ...
            {role === 'STUDENT' ? (
              <div className="space-y-3 pt-2 border-t border-white/5">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2 bg-dark-bg/60 border border-white/10 rounded-xl text-xs text-white focus:outline-none focus:border-purple-500 font-bold"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-semibold text-gray-300 mb-1">Guardian Name <span className="text-purple-400 font-normal">(Optional)</span></label>
                    <input
                      type="text"
                      value={guardianName}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-300 mb-1">Guardian Contact Phone <span className="text-purple-400 font-normal">(Optional)</span></label>
                    <input
                      type="text"
